...
!  i.e. rho_multipole = rho_multipole(r) . For convenience
  ...
  ! integer :: rho_multipole_tile_size = 128
...
!  counters
  ...
  ! call aims_stop("update_hartree_potential_p1 should not be called in this version", "update_hartree_potential_p1")
...
!  begin work
  ...
  if (myid .eq. 0) print*, "flag_delta_rho_in_multipole=", flag_delta_rho_in_multipole
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_shanghui:part1=", mpi_wtime()-time0
  time0 = mpi_wtime()
  ...
  do i_atom_block = 1, n_atoms, rho_multipole_tile_size
    ...
    call sync_vector_no_limit(tile_rho_multipole, ((l_pot_max+1)**2)*(n_max_radial+2)*rho_multipole_tile_size)
    ! if (shm_rank .eq. 0) call sync_vector(tile_rho_multipole, ((l_pot_max+1)**2)*(n_max_radial+2)*rho_multipole_tile_size, shm_per0_comm)
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_shanghui:part2=", mpi_wtime()-time0
  time0 = mpi_wtime()
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_shanghui:part3=", mpi_wtime()-time0
  time0 = mpi_wtime()
...
!     end loop over atoms 
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_shanghui:part4=", mpi_wtime()-time0
  time0 = mpi_wtime()
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_shanghui:part5=", mpi_wtime()-time0
...
!****s* FHI-aims/update_hartree_potential_p1_without_old
!  NAME
!    update_hartree_potential_p1_without_old
!  SYNOPSIS

subroutine update_hartree_potential_p1_without_old &
     ( partition_tab, free_rho_superpos, &
     rho, rho_multipole_old, &
     delta_v_hartree_part_at_zero, &
     delta_v_hartree_deriv_l0_at_zero, &
...
!  i.e. rho_multipole = rho_multipole(r) . For convenience
  ...
  ! integer :: rho_multipole_tile_size = 512
...
!  begin work
  ...
  if (myid .eq. 0) print*, "flag_delta_rho_in_multipole=", flag_delta_rho_in_multipole
  if(flag_delta_rho_in_multipole)then
    call aims_stop("without rho_radial_multipole_old", "update_hartree_potential_p1_without_old")
    ! do i_atom_index = 1, n_rho_multipole_atoms
    !   i_atom = i_rho_multipole_atoms(i_atom_index)
    !   rho_multipole(:,:,i_atom_index) = rho_multipole(:,:,i_atom_index) + rho_radial_multipole_old(:,:,i_atom)
    !   rho_radial_multipole_old(:,:,i_atom) = rho_radial_multipole_old(:,:,i_atom) * (1.d0-multipole_feed_back_parameter) &
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_without_old:part1=", mpi_wtime()-time0
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_without_old:part2=", mpi_wtime()-time0
  time0 = mpi_wtime()
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_without_old:part3=", mpi_wtime()-time0
  time0 = mpi_wtime()
...
!     end loop over atoms 
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_without_old:part4=", mpi_wtime()-time0
  time0 = mpi_wtime()
  ...
  if(myid .eq. 0) print*, "myid=", myid, " update_hartree_potential_p1_without_old:part5=", mpi_wtime()-time0
...
end subroutine update_hartree_potential_p1_without_old
!******
