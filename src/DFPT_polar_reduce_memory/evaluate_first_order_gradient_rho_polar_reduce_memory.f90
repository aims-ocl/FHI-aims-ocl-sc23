!****s* FHI-aims/evaluate_first_order_gradient_rho_polar_reduce_memory
!  NAME
!   evaluate_first_order_gradient_rho_polar_reduce_memory
!  SYNOPSIS

subroutine evaluate_first_order_gradient_rho_polar_reduce_memory( & 
...
!  ARGUMENTS
  ...
  real*8:: first_order_density_matrix(n_basis, n_basis)
 ...
 !     external functions
  ...
  first_order_gradient_rho(1:3,1:n_points) = 0.0d0
       ...
       do i_point=1, n_points,1
          ...
          first_order_gradient_rho(1:3, i_point)=0.0d0
...
end subroutine evaluate_first_order_gradient_rho_polar_reduce_memory
!---------------------------------------------------------------------
!******	 
