...
subroutine sum_up_whole_potential_p2_shanghui &
...
!                     v_hartree_gradient_temp =  dir_tab_out(:) * d_v_hartree_free_d_r
  ...
  hartree_multipole_error =   &
     ...
     write(info_str,'(2X,A,1X,E14.6)')  &
          ...
          hartree_multipole_error
     if (myid == 0) print *, 'hartree_multipole_error=', hartree_multipole_error
     call localorb_info(info_str, use_unit,'(A)', OL_norm )
...
end subroutine  sum_up_whole_potential_p2_shanghui
!******
!------------------------------------------------------------------------------------------------------------
