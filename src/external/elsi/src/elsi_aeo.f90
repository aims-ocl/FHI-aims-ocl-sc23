...
subroutine elsi_solve_elpa_real(ph,bh,ham,ovlp,eval,evec)
   ...
   write(msg,"(A)") "Starting ELPA eigensolver (elsi_solve_elpa_real aeo)"
   call elsi_say(bh,msg)
   ...
   write(msg,"(A)") "Finished solving standard eigenproblem (elsi_solve_elpa_real aeo)"
   call elsi_say(bh,msg)
   write(msg,"(A,F10.3,A)") "| Time :",t1-t0," s"
   call elsi_say(bh,msg)
...
subroutine elsi_solve_elpa_cmplx(ph,bh,ham,ovlp,eval,evec)
   ...
   write(msg,"(A)") "Starting ELPA eigensolver (elsi_solve_elpa_cmplx aeo)"
   call elsi_say(bh,msg)
   ...
   write(msg,"(A)") "Finished solving standard eigenproblem (elsi_solve_elpa_cmplx aeo)"
   call elsi_say(bh,msg)
   write(msg,"(A,F10.3,A)") "| Time :",t1-t0," s"
   call elsi_say(bh,msg)
