...
!****s* FHI-aims/sum_up_whole_potential_shanghui_phonon_reduce_memory
!  NAME
!   sum_up_whole_potential_shanghui_phonon_reduce_memory
!  SYNOPSIS

subroutine sum_up_whole_potential_shanghui_phonon_reduce_memory &
          ...
          do i_atom_2 = 1, n_occ_atoms, 1
            ...
            if(forces_on)then
               ...
               hellman_feynman_term(1:3, i_atom_2 ) =  hellman_feynman_term(1:3, i_atom_2) &
                    - HF_forces(1:3) !*k_phase(center_to_cell(current_center),i_q_point) 

               ! shanghui change to '-', we need hessian. 
...
end subroutine sum_up_whole_potential_shanghui_phonon_reduce_memory
!******
!------------------------------------------------------------------------------------------------------------
